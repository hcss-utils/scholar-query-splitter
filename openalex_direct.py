...
class OpenAlexDownloader:
    ...
    def download_metadata(self, query: str, max_results: int = 1000, 
        ...
        # Add OA filters (make them optional to get more results)
        ...
        try:
            while len(all_results) < max_results:
                ...
                if len(all_results) == 0:
                    ...
                    if total_count == 0:
                        logger.warning("No results found for this query and year range")
                        break
                    # Update progress bar total
                    pbar.total = min(total_count, max_results)
                    pbar.refresh()
